...
public class JMFAudioVideoPlayer implements AudioVideoPlayer {
    /*******************************************************************************************************************
     * Audio/Video Player *
     ******************************************************************************************************************/
    private Player player, audioPlayer, videoPlayer;

    private JInternalFrame playerFrame;
    ...
    public JMFAudioVideoPlayer(String fileName, Recording recording) throws IOException {
        // audio player
